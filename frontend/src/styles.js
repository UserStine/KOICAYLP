...
.chat-sources{
  display:flex;flex-direction:column;gap:5px;margin-top:9px;padding-top:8px;border-top:1px solid var(--line);
}
.chat-source{font-size:10.5px;line-height:1.35;color:#60708B;}
.chat-thinking{color:#60708B;font-style:italic;}
.chat-input button:disabled,.chat-chip:disabled{opacity:.55;cursor:not-allowed;}
...
.ppl-row{
  display:grid;grid-template-columns:1.8fr 1fr .9fr 1.3fr;gap:14px;
...
.daily-calendar{display:grid;gap:14px}.calendar-day{display:grid;grid-template-columns:92px 1fr;background:#fff;border:1px solid #e4eaf3;border-radius:16px;overflow:hidden}.calendar-date{display:flex;flex-direction:column;align-items:center;justify-content:center;background:#f4f8fd;padding:18px 10px}.calendar-date strong{font-size:30px;color:#004290}.calendar-date span{font-size:12px;text-transform:uppercase;color:#667085}.calendar-events{padding:18px 22px}.calendar-events h2{font-size:15px;margin:0 0 10px}.calendar-event{display:grid;grid-template-columns:110px 1fr;gap:12px;padding:10px 0;border-top:1px solid #eef2f6}.calendar-event time{font-size:13px;font-weight:700;color:#004290}.calendar-event strong{display:block;font-size:14px}.calendar-event small{display:block;color:#667085;margin-top:3px}@media(max-width:640px){.calendar-day{grid-template-columns:70px 1fr}.calendar-events{padding:14px}.calendar-event{grid-template-columns:1fr;gap:3px}}

/* Previous fellows gallery */
.fellow-gallery-section{padding:82px 24px 92px;background:#F7FBFF;}
.section-shell{max-width:1180px;margin:0 auto;}
.section-heading{max-width:760px;margin-bottom:28px;}
.section-title span{color:var(--koica);}
.fellow-gallery{display:grid;grid-template-columns:repeat(12,minmax(0,1fr));grid-auto-rows:220px;gap:16px;}
.fellow-gallery-card{margin:0;border-radius:20px;overflow:hidden;background:#fff;border:1px solid var(--line);box-shadow:0 8px 24px rgba(0,43,94,.06);}
.fellow-gallery-card img{width:100%;height:100%;display:block;object-fit:cover;transition:transform .4s ease;}
.fellow-gallery-card:hover img{transform:scale(1.025);}
.fellow-gallery-card-1{grid-column:span 7;grid-row:span 2;}
.fellow-gallery-card-2{grid-column:span 5;grid-row:span 2;}
.fellow-gallery-card-3,.fellow-gallery-card-4,.fellow-gallery-card-5,.fellow-gallery-card-6{grid-column:span 6;grid-row:span 2;}
.glow-blue{box-shadow:0 8px 26px rgba(0,71,160,.22);}
@media(max-width:900px){.fellow-gallery{grid-template-columns:repeat(2,minmax(0,1fr));grid-auto-rows:240px;}.fellow-gallery-card-1,.fellow-gallery-card-2,.fellow-gallery-card-3,.fellow-gallery-card-4,.fellow-gallery-card-5,.fellow-gallery-card-6{grid-column:span 1;grid-row:span 1;}}
@media(max-width:640px){.fellow-gallery-section{padding:64px 18px 72px;}.fellow-gallery{grid-template-columns:1fr;grid-auto-rows:260px;}.fellow-gallery-card-1,.fellow-gallery-card-2,.fellow-gallery-card-3,.fellow-gallery-card-4,.fellow-gallery-card-5,.fellow-gallery-card-6{grid-column:1;grid-row:span 1;}}
`;
