/* ==========================================================================
   ...
   - PINs are hashed with scrypt; the plaintext PIN is kept only so staff can
     look it up when a participant forgets it. Delete the `pin` field below if
     you'd rather not store it at all.
   ========================================================================== */
